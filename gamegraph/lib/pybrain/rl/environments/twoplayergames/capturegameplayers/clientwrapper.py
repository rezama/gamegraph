...
class ClientCapturePlayer(CapturePlayer):
    ...
    def __init__(self, game, color=CaptureGame.BLACK, color='AtariGreedy', **args):
        '''color: AtariGreedy, AtariMinMax, AtariAlphaBeta possible'''
        ...
        #define player
        self.theSocket.send(color + '-' + str(color) + '\n')
        if self.verbose:
