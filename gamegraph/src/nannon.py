...
class NannonState(object):
    ...
    # graph
    RECORD_GAME_GRAPH = StateGraph(NannonDie.SIDES, 1, NannonAction.ALL_ACTIONS)
    GAME_GRAPH = None
...
#        print '-'
    ...
    def generate_graph(cls, exp_params):
        ...
        s_pos = [[s.pos[0][0], s.pos[0][1], s.pos[0][2]],
                 [s.pos[1][0], s.pos[1][1], s.pos[1][2]]]
        ...
        while not Q.empty():
            ...
            for roll in NannonDie.SIDES:
                s.roll = roll
                must_consider_forfeit = True
                for action in NannonAction.ALL_ACTIONS:
                    if (action != NannonAction.ACTION_FORFEIT_MOVE) or must_consider_forfeit:
                        ...
                        if sp is not None:
                            ...
                            if is_state_processed.has_key(sp_key):
                                ...
                                sp_pos = [[sp.pos[0][0], sp.pos[0][1], sp.pos[0][2]],
                                          [sp.pos[1][0], sp.pos[1][1], sp.pos[1][2]]]
