...
SARSA_NUM_ITERATIONS = 1000 * 1024
#SARSA_NUM_ITERATIONS = 1 * 1024
SARSA_NUM_FINAL_EVAL = 1024

SARSA_TRAIN_AGAINST_SELF = False

SARSA_SAVE_TRIAL_DATA = True
...
GAMESET_PROGRESS_REPORT_EVERY_N_GAMES = SARSA_NUM_ITERATIONS / 1000
